 ...
 */
public class FlutterShareMePlugin implements MethodCallHandler, FlutterPlugin, ActivityAware, PluginRegistry.ActivityResultListener {
     ...
     * @param result Result
     */
    private void shareToFacebook(String url, String msg, final Result result) {
        ...
        shareDialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>() {
            ...
            public void onSuccess(Sharer.Result shareResult) {
                Log.d("shareToFacebook", "success");
                result.success("success");
            }

            @Override
            public void onCancel() {
                Log.d("shareToFacebook", "cancel");
                result.success("cancel");
            }

            @Override
            public void onError(FacebookException error) {
                Log.d("shareToFacebook", error.getMessage());
